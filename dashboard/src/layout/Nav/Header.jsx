          ...
          <div className="max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-75 max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            <div className="flex items-center max-lg:flex-col-reverse max-lg:ml-auto gap-8">
              ...
              <div className="dropdown-menu relative flex shrink-0 group">
                ...
                />
                <div className="dropdown-content hidden group-hover:block shadow-md p-2 bg-white rounded-md absolute top-9 right-0 w-100">
                  <div className="bg-white p-6 border border-gray-200 shadow-md w-full max-w-sm rounded-2xl overflow-hidden mx-auto mt-4">
